...
def parse_timedelta(string):
    """
    This method is taken from django-time-delta. It's the only reason that
    django-time-delta is included as a package, which seems absurd, since
    this method has no external dependencies and should just be a small
    library. For now it comes from here:
    https://bitbucket.org/schinckel/django-timedelta-field/src/07bbf5159b958c7587fb93633813965cb6e6d427/timedelta/helpers.py?at=default&fileviewer=file-view-default
